...
@Service
public class OpenMRSDrugOrderClientImpl implements OpenMRSDrugOrderClient {
    ...
    @Autowired
    public OpenMRSDrugOrderClientImpl(PatientService patientService, OrderService orderService, PrescriptionOrderDao prescriptionOrderDao) {
    ...
    @Override
    public List<DrugOrder> drugOrdersFor(String patientUUID, String visitType) {
    ...
    @Override
    public Map<Encounter, DrugOrders> getDrugOrdersByDateAndVisitTypeFor(Visit visit, Date fromDate, Date toDate) {
    ...
    @Override
    public Map<Encounter, DrugOrders> getDrugOrdersByDateAndProgramFor(String forPatientUUID, DateRange dateRange, String programName, String programEnrolmentId) {
