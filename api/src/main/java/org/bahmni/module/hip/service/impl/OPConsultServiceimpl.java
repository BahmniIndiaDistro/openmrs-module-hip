...
import org.bahmni.module.hip.builder.FhirBundledOPConsultBuilder;
...
import org.bahmni.module.hip.service.OPConsultService;
...
@Service
public class OPConsultServiceimpl implements OPConsultService {
    ...
    @Autowired
    public OPConsultServiceimpl(FhirBundledOPConsultBuilder fhirBundledOPConsultBuilder,
