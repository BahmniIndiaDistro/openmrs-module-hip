...
import org.bahmni.module.hip.builder.FhirImmunizationRecordBundleBuilder;
...
public class ImmunizationRecordServiceImpl implements ImmunizationRecordService {
    ...
    @Autowired
    public ImmunizationRecordServiceImpl(VisitService visitService, ConceptService conceptService,
