...
import org.bahmni.module.hip.builder.FhirBundledDiagnosticReportBuilder;
...
public class DiagnosticReportServiceImpl implements DiagnosticReportService {
    ...
    @Autowired
    public DiagnosticReportServiceImpl(FhirBundledDiagnosticReportBuilder fhirBundledDiagnosticReportBuilder,
